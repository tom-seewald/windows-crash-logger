...
$DiagLogTemp       = "licensingdiag-log-" + $Guid + ".txt"
$LicenseDiagLog    = Join-Path -Path $env:TEMP -ChildPath $DiagLogTemp
$LicenseFile       = Join-Path -Path $Path -ChildPath "genuine.txt"
$LicneseXmlName    = "genuine-" + $Guid + ".xml"
$LicenseXmlTemp    = Join-Path -Path $env:TEMP -ChildPath $LicneseXmlName
